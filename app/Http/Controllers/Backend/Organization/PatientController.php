...
use App\Http\Requests\Backend\Organization\PatientRequest;
...
class PatientController extends Controller
{
    ...
    {
        return view('backend.organization.patient.create');
    }
    ...
    public function show($id)
    {
        if ($patient = $this->patientService->getPatientById($id)) {
            return view('backend.organization.patient.show', [
                'patient' => $patient,
    ...
    {
        if ($patient = $this->patientService->getPatientById($id)) {
            return view('backend.organization.patient.edit', [
                'patient' => $patient,
            ]);
        }
    ...
    {
        return view('backend.organization.patientimport');
    }
    ...
    public function importBulk(Request $request)
    {
        ...
        return view('backend.organization.patientindex', [
            'patients' => $patients,
        ]);
    }
