<div class="card-body">
    <div class="row">
        <div class="col-md-12">{!! Form::nText('vaers_id', 'vaers_id', old('vaers_id', $symptom->vaers_id ?? null), true) !!}</div>
 <div class="col-md-6">{!! Form::nText('symptom1', 'symptom1', old('symptom1', $symptom->symptom1 ?? null), true) !!}</div>
 <div class="col-md-6">{!! Form::nText('symptomversion1', 'symptomversion1', old('symptomversion1', $symptom->symptomversion1 ?? null), true) !!}</div>
 <div class="col-md-6">{!! Form::nText('symptom2', 'symptom2', old('symptom2', $symptom->symptom2 ?? null), true) !!}</div>
 <div class="col-md-6">{!! Form::nText('symptomversion2', 'symptomversion2', old('symptomversion2', $symptom->symptomversion2 ?? null), true) !!}</div>
 <div class="col-md-6">{!! Form::nText('symptom3', 'symptom3', old('symptom3', $symptom->symptom3 ?? null), true) !!}</div>
 <div class="col-md-6">{!! Form::nText('symptomversion3', 'symptomversion3', old('symptomversion3', $symptom->symptomversion3 ?? null), true) !!}</div>
 <div class="col-md-6">{!! Form::nText('symptom4', 'symptom4', old('symptom4', $symptom->symptom4 ?? null), true) !!}</div>
 <div class="col-md-6">{!! Form::nText('symptomversion4', 'symptomversion4', old('symptomversion4', $symptom->symptomversion4 ?? null), true) !!}</div>
 <div class="col-md-6">{!! Form::nText('symptom5', 'symptom5', old('symptom5', $symptom->symptom5 ?? null), true) !!}</div>
