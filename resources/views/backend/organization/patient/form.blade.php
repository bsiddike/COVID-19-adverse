<div class="card-body">
    <div class="row">
        ...
        <div class="col-md-6">{!! Form::nText('recive_date', 'recive_date', old('recive_date', $patient->recive_date ?? null), true) !!}</div>
        ...
        <div class="col-md-6">{!! Form::nText('rpt_date', 'rpt_date', old('rpt_date', $patient->rpt_date ?? null), true) !!}</div>
        {{--                                            <div class="col-md-6">{!! Form::nText('symptom_text', 'symptom_text', old('symptom_text', $patient->symptom_text ?? null), true) !!}</div>--}}
        ...
        <div class="col-md-6">{!! Form::nText('l_threat', 'l_threat', old('l_threat', $patient->l_threat ?? null), true) !!}</div>
        <div class="col-md-6">{!! Form::nText('er_visit', 'er_visit', old('er_visit', $patient->er_visit ?? null), true) !!}</div>
        ...
        <div class="col-md-6">{!! Form::nText('x_stay', 'x_stay', old('x_stay', $patient->x_stay ?? null), true) !!}</div>
        <div class="col-md-6">{!! Form::nText('disable', 'disable', old('disable', $patient->disable ?? null), true) !!}</div>
        <div class="col-md-6">{!! Form::nText('recovd', 'recovd', old('recovd', $patient->recovd ?? null), true) !!}</div>
        <div class="col-md-6">{!! Form::nText('vax_date', 'vax_date', old('vax_date', $patient->vax_date ?? null), true) !!}</div>
        ...
        <div class="col-md-6">{!! Form::nText('lab_data', 'lab_data', old('lab_data', $patient->lab_data ?? null), true) !!}</div>
        ...
        <div class="col-md-6">{!! Form::nText('cur_ill', 'cur_ill', old('cur_ill', $patient->cur_ill ?? null), true) !!}</div>
        <div class="col-md-6">{!! Form::nText('history', 'history', old('history', $patient->history ?? null), true) !!}</div>
        <div class="col-md-6">{!! Form::nText('prior_vax', 'prior_vax', old('prior_vax', $patient->prior_vax ?? null), true) !!}</div>
        ...
        <div class="col-md-6">{!! Form::nText('todays_date', 'todays_date', old('todays_date', $patient->todays_date ?? null), true) !!}</div>
        <div class="col-md-6">{!! Form::nText('birth_defect', 'birth_defect', old('birth_defect', $patient->birth_defect ?? null), true) !!}</div>
        <div class="col-md-6">{!! Form::nText('ofc_visit', 'ofc_visit', old('ofc_visit', $patient->ofc_visit ?? null), true) !!}</div>
