...
class Container_b73d232fa4 extends _PHPStan_71ced81c9\Nette\DI\Container
{
	protected $tags = [
		...
		'phpstan.typeSpecifier.methodTypeSpecifyingExtension' => ['0210' => true, '0432' => true],
		'phpstan.rules.rule' => [
			'0290' => true,
			'0291' => true,
			'0292' => true,
		...
		'phpstan.typeSpecifier.staticMethodTypeSpecifyingExtension' => ['0433' => true],
	];
	...
	protected $wiring = [
		...
		'NunoMaduro\Larastan\Rules\RelationExistenceRule' => [['rules.136'], ['0426']],
		...
		'PHPStan\Reflection\MethodsClassReflectionExtension' => [
			['072', '082', '084', '086', '0357', '0358', '0359', '0360', '0361', '0362', '0363', '0364', '0365', '0366'],
		],
		...
		'PHPStan\Reflection\PropertiesClassReflectionExtension' => [
			['073', '083', '084', '087', '0200', '0367', '0368', '0369', '0377'],
		],
		...
		'PHPStan\Type\DynamicStaticMethodReturnTypeExtension' => [
			['0167', '0169', '0271', '0277', '0378', '0379', '0380', '0381', '0388', '0391', '0411'],
		],
		...
		'PHPStan\Type\MethodTypeSpecifyingExtension' => [['0210', '0432']],
		...
		'Composer\PHPStan\ConfigReturnTypeExtension' => [['0355']],
		'Composer\PHPStan\RuleReasonDataReturnTypeExtension' => [['0356']],
		...
		'NunoMaduro\Larastan\ReturnTypes\ModelExtension' => [['0379']],
		'NunoMaduro\Larastan\ReturnTypes\AuthExtension' => [['0380']],
		'NunoMaduro\Larastan\ReturnTypes\GuardDynamicStaticMethodReturnTypeExtension' => [['0381']],
		'NunoMaduro\Larastan\ReturnTypes\AuthManagerExtension' => [['0382']],
		'NunoMaduro\Larastan\ReturnTypes\GuardExtension' => [['0383']],
		'NunoMaduro\Larastan\ReturnTypes\RequestExtension' => [['0384']],
		...
		'NunoMaduro\Larastan\ReturnTypes\CollectionMakeDynamicStaticMethodReturnTypeExtension' => [['0391']],
		'NunoMaduro\Larastan\Support\CollectionHelper' => [['0392']],
		'NunoMaduro\Larastan\ReturnTypes\Helpers\AuthExtension' => [['0393']],
		'NunoMaduro\Larastan\ReturnTypes\Helpers\CollectExtension' => [['0394']],
		'NunoMaduro\Larastan\ReturnTypes\Helpers\CookieExtension' => [['0395']],
		'NunoMaduro\Larastan\ReturnTypes\Helpers\ResponseExtension' => [['0396']],
		'NunoMaduro\Larastan\ReturnTypes\Helpers\RequestExtension' => [['0397']],
		'NunoMaduro\Larastan\ReturnTypes\Helpers\RedirectExtension' => [['0398']],
		'NunoMaduro\Larastan\ReturnTypes\Helpers\UrlExtension' => [['0399']],
		'NunoMaduro\Larastan\ReturnTypes\Helpers\ViewExtension' => [['0400']],
		'NunoMaduro\Larastan\ReturnTypes\Helpers\TransExtension' => [['0401']],
		'NunoMaduro\Larastan\ReturnTypes\Helpers\ValidatorExtension' => [['0402']],
		'NunoMaduro\Larastan\ReturnTypes\CollectionFilterDynamicReturnTypeExtension' => [['0403']],
		...
		'PHPStan\PhpDoc\TypeNodeResolverExtension' => [['0412', '0413', '0419', '0420', '0430']],
		...
		'PHPStan\Rules\Deprecations\DeprecatedClassHelper' => [['0429']],
		'PHPStan\PhpDoc\TypeNodeResolverAwareExtension' => [['0430']],
		'PHPStan\PhpDoc\PHPUnit\MockObjectTypeNodeResolverExtension' => [['0430']],
		'PHPStan\Type\PHPUnit\Assert\AssertFunctionTypeSpecifyingExtension' => [['0431']],
		'PHPStan\Type\PHPUnit\Assert\AssertMethodTypeSpecifyingExtension' => [['0432']],
		'PHPStan\Type\StaticMethodTypeSpecifyingExtension' => [['0433']],
		'PHPStan\Type\PHPUnit\Assert\AssertStaticMethodTypeSpecifyingExtension' => [['0433']],
		'PHPStan\Type\PHPUnit\InvocationMockerDynamicReturnTypeExtension' => [['0434']],
		'PHPStan\Type\PHPUnit\MockBuilderDynamicReturnTypeExtension' => [['0435']],
		'PHPStan\Type\PHPUnit\MockObjectDynamicReturnTypeExtension' => [['0436']],
		'PHPStan\Rules\PHPUnit\CoversHelper' => [['0437']],
		'PHPStan\Rules\PHPUnit\AnnotationHelper' => [['0438']],
		'PHPStan\Rules\PHPUnit\ClassCoversExistsRule' => [['0439']],
		'PHPStan\Rules\PHPUnit\ClassMethodCoversExistsRule' => [['0440']],
		'PHPStan\Rules\PHPUnit\NoMissingSpaceInClassAnnotationRule' => [['0441']],
		'PHPStan\Rules\PHPUnit\NoMissingSpaceInMethodAnnotationRule' => [['0442']],
	];
	...
	public function createService042(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_b73d232fa4 $container)
			{
	...
	public function createService0355(): Composer\PHPStan\ConfigReturnTypeExtension
	{
		return new Composer\PHPStan\ConfigReturnTypeExtension;
	}


	public function createService0356(): Composer\PHPStan\RuleReasonDataReturnTypeExtension
	{
	...
	{
		return new NunoMaduro\Larastan\Properties\ModelPropertyExtension($this->getService('030'), $this->getService('0422'));
	}
	...
	{
		return new NunoMaduro\Larastan\Properties\ModelRelationsExtension($this->getService('0421'), $this->getService('0425'));
	}
	...
	public function createService0379(): NunoMaduro\Larastan\ReturnTypes\ModelExtension
	{
		return new NunoMaduro\Larastan\ReturnTypes\ModelExtension($this->getService('0425'));
	}


	public function createService0380(): NunoMaduro\Larastan\ReturnTypes\AuthExtension
	{
		return new NunoMaduro\Larastan\ReturnTypes\AuthExtension;
	}


	public function createService0381(): NunoMaduro\Larastan\ReturnTypes\GuardDynamicStaticMethodReturnTypeExtension
	{
		return new NunoMaduro\Larastan\ReturnTypes\GuardDynamicStaticMethodReturnTypeExtension;
	}


	public function createService0382(): NunoMaduro\Larastan\ReturnTypes\AuthManagerExtension
	{
	...
	public function createService0384(): NunoMaduro\Larastan\ReturnTypes\RequestExtension
	{
	...
	public function createService0391(): NunoMaduro\Larastan\ReturnTypes\CollectionMakeDynamicStaticMethodReturnTypeExtension
	{
		return new NunoMaduro\Larastan\ReturnTypes\CollectionMakeDynamicStaticMethodReturnTypeExtension($this->getService('0392'));
	}


	public function createService0392(): NunoMaduro\Larastan\Support\CollectionHelper
	{
		return new NunoMaduro\Larastan\Support\CollectionHelper;
	}


	public function createService0393(): NunoMaduro\Larastan\ReturnTypes\Helpers\AuthExtension
	{
		return new NunoMaduro\Larastan\ReturnTypes\Helpers\AuthExtension;
	}


	public function createService0394(): NunoMaduro\Larastan\ReturnTypes\Helpers\CollectExtension
	{
		return new NunoMaduro\Larastan\ReturnTypes\Helpers\CollectExtension($this->getService('0392'));
	}


	public function createService0395(): NunoMaduro\Larastan\ReturnTypes\Helpers\CookieExtension
	{
		return new NunoMaduro\Larastan\ReturnTypes\Helpers\CookieExtension;
	}


	public function createService0396(): NunoMaduro\Larastan\ReturnTypes\Helpers\ResponseExtension
	{
		return new NunoMaduro\Larastan\ReturnTypes\Helpers\ResponseExtension;
	}


	public function createService0397(): NunoMaduro\Larastan\ReturnTypes\Helpers\RequestExtension
	{
		return new NunoMaduro\Larastan\ReturnTypes\Helpers\RequestExtension;
	}


	public function createService0398(): NunoMaduro\Larastan\ReturnTypes\Helpers\RedirectExtension
	{
		return new NunoMaduro\Larastan\ReturnTypes\Helpers\RedirectExtension;
	}


	public function createService0399(): NunoMaduro\Larastan\ReturnTypes\Helpers\UrlExtension
	{
	...
	public function createService0401(): NunoMaduro\Larastan\ReturnTypes\Helpers\TransExtension
	{
		return new NunoMaduro\Larastan\ReturnTypes\Helpers\TransExtension;
	}


	public function createService0402(): NunoMaduro\Larastan\ReturnTypes\Helpers\ValidatorExtension
	{
		return new NunoMaduro\Larastan\ReturnTypes\Helpers\ValidatorExtension;
	}


	public function createService0403(): NunoMaduro\Larastan\ReturnTypes\CollectionFilterDynamicReturnTypeExtension
	{
	...
	{
		return new NunoMaduro\Larastan\Types\ModelProperty\ModelPropertyTypeNodeResolverExtension($this->getService('028'), true);
	}
	...
	public function createService0429(): PHPStan\Rules\Deprecations\DeprecatedClassHelper
	{
		return new PHPStan\Rules\Deprecations\DeprecatedClassHelper($this->getService('reflectionProvider'));
	}


	public function createService0430(): PHPStan\PhpDoc\PHPUnit\MockObjectTypeNodeResolverExtension
	{
		return new PHPStan\PhpDoc\PHPUnit\MockObjectTypeNodeResolverExtension;
	}


	public function createService0431(): PHPStan\Type\PHPUnit\Assert\AssertFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\PHPUnit\Assert\AssertFunctionTypeSpecifyingExtension;
	}


	public function createService0432(): PHPStan\Type\PHPUnit\Assert\AssertMethodTypeSpecifyingExtension
	{
		return new PHPStan\Type\PHPUnit\Assert\AssertMethodTypeSpecifyingExtension;
	}


	public function createService0433(): PHPStan\Type\PHPUnit\Assert\AssertStaticMethodTypeSpecifyingExtension
	{
		return new PHPStan\Type\PHPUnit\Assert\AssertStaticMethodTypeSpecifyingExtension;
	}


	public function createService0434(): PHPStan\Type\PHPUnit\InvocationMockerDynamicReturnTypeExtension
	{
		return new PHPStan\Type\PHPUnit\InvocationMockerDynamicReturnTypeExtension;
	}


	public function createService0435(): PHPStan\Type\PHPUnit\MockBuilderDynamicReturnTypeExtension
	{
		return new PHPStan\Type\PHPUnit\MockBuilderDynamicReturnTypeExtension;
	}


	public function createService0436(): PHPStan\Type\PHPUnit\MockObjectDynamicReturnTypeExtension
	{
		return new PHPStan\Type\PHPUnit\MockObjectDynamicReturnTypeExtension;
	}


	public function createService0437(): PHPStan\Rules\PHPUnit\CoversHelper
	{
		return new PHPStan\Rules\PHPUnit\CoversHelper($this->getService('reflectionProvider'));
	}


	public function createService0438(): PHPStan\Rules\PHPUnit\AnnotationHelper
	{
		return new PHPStan\Rules\PHPUnit\AnnotationHelper;
	}


	public function createService0439(): PHPStan\Rules\PHPUnit\ClassCoversExistsRule
	{
		return new PHPStan\Rules\PHPUnit\ClassCoversExistsRule($this->getService('0437'), $this->getService('reflectionProvider'));
	}


	public function createService0440(): PHPStan\Rules\PHPUnit\ClassMethodCoversExistsRule
	{
		return new PHPStan\Rules\PHPUnit\ClassMethodCoversExistsRule($this->getService('0437'), $this->getService('0131'));
	}


	public function createService0441(): PHPStan\Rules\PHPUnit\NoMissingSpaceInClassAnnotationRule
	{
		return new PHPStan\Rules\PHPUnit\NoMissingSpaceInClassAnnotationRule($this->getService('0438'));
	}


	public function createService0442(): PHPStan\Rules\PHPUnit\NoMissingSpaceInMethodAnnotationRule
	{
		return new PHPStan\Rules\PHPUnit\NoMissingSpaceInMethodAnnotationRule($this->getService('0438'));
	}
	...
	public function createServiceContainer(): Container_b73d232fa4
	{
		return $this;
	}
	...
	{
		return new PHPStan\Rules\Deprecations\TypeHintDeprecatedInClassMethodSignatureRule($this->getService('0429'));
	}


	public function createServiceRules__149(): PHPStan\Rules\Deprecations\TypeHintDeprecatedInClosureSignatureRule
	{
		return new PHPStan\Rules\Deprecations\TypeHintDeprecatedInClosureSignatureRule($this->getService('0429'));
	}
	...
	{
		return new PHPStan\Rules\Deprecations\TypeHintDeprecatedInFunctionSignatureRule($this->getService('0429'));
	}
