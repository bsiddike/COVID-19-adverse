...
class VaccineController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('frontend.vaccine.index', [
            'vaccines' => $vaccines,
        ]);
    }
    ...
    {
        return view('frontend.vaccine.create');
    }
    ...
    public function store(CreateVaccineRequest $request): RedirectResponse
    {
        ...
        if ($confirm['status'] == true) {
            ...
            return redirect()->route('frontend.vaccines.index');
        }
    ...
    public function show($id)
    {
        if ($vaccine = $this->vaccineService->getVaccineById($id)) {
            return view('frontend.vaccine.show', [
                'vaccine' => $vaccine,
    ...
    {
        if ($vaccine = $this->vaccineService->getVaccineById($id)) {
            return view('frontend.vaccine.edit', [
                'vaccine' => $vaccine,
            ]);
        }
    ...
    public function ajax(Request $request): JsonResponse
    {
        ...
        if (count($vaccines) > 0) {
            foreach ($vaccines as $index => $vaccine) {
                $vaccines[$index]->update_route = route('frontend.vaccines.update', $vaccine->id);
